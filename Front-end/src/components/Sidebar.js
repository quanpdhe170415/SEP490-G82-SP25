                ...
                {menuItems.map((item) => (
                    <a 
                        ...
                        style={{
                            ...
                            ...(activeItem === item.id ? sidebarStyles.sidebarNavItemActive : {})
                        }}
                        href={item.href}
                        title={isCollapsed ? item.label : ''}
                        onMouseEnter={(e) => {
                            if (activeItem !== item.id) {
                                Object.assign(e.target.style, sidebarStyles.sidebarNavItemHover);
                            }
                        }}
                        onMouseLeave={(e) => {
                            if (activeItem !== item.id) {
                    ...
                    >
                        ...
                        {!isCollapsed && <span style={sidebarStyles.labelText}>{item.label}</span>}
                    </a>
                ))}
            </nav>
